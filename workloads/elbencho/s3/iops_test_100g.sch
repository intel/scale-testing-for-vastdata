...
--read  --blockvarpct=100 --threads=4 --block=4k --size=1280m --dirs=1 --files=5 --s3randobj --timelimit=300 --infloop elbencho-s3-bucket1-100g
# Write 10T (> 2 * 4T) of data to fully destage the previous data to QLC 
--write --blockvarpct=100 --threads=16 --block=32m --size=160m --dirs=1 --files=200 --mkdirs elbencho-s3-bucket2-100g
